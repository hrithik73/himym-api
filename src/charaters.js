const characters = [
  {
    ...
    nickNames: ["T - Dog", "T - Mose", "Teddy Westside", "Schmosby, Prof.Brosby", "Doctor X",
      ...
      "Sex Architect", "Emsbry Postlethwaite", "El Ganso Con la Riñonera", "Lady Tedwina Slowsby", "Universe Guy",
      "Architect of Destruction", "Pooh Bear", "The Blitz"],
    actor: "Josh Radnor",
...

  {
    ...
    occupation: "Provide Legal Exculpation and Sign Everything (P.L.E.A.S.E)"
  },
  {
  ...
  },
  {
    ...
    actor: "Male",
    occupation: ["New York State Supreme Court Judge (2020 - Present)", "Judge (2018 - Present)", "Lawyer (Goliath National Bank (Season 4-6)", "Honeywell & Cootes(Season 7 - present)"]
  },
  {
